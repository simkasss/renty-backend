...
contract RentApp {
    ...
    function listProperty(string memory _name, string memory _description, uint256 _propertyNftId, string memory _rentalTerm, uint256 _rentalPrice, uint256 _depositAmount, string memory _hash) external onlyPropertyOwner(_propertyNftId)  {
    ...
    function updateProperty(string memory _name, string memory _description, uint256 _propertyNftId, string memory _rentalTerm, uint256 _rentPrice, uint256 _depositAmount, string memory _hash) external onlyPropertyOwner(_propertyNftId)  {
        ...
        tokenIdToProperty[_tokenId].description = _description;
         ...
         tokenIdToProperty[_tokenId].depositAmount = _depositAmount;
    ...
    function createRentContract(uint256 _propertyNftId, uint256 _tenantTokenId, string memory _rentalTerm, uint256 _rentalPrice, uint256 _depositAmount, string memory _startDate, uint256 _days ) external onlyTSBTOwner(_tenantTokenId) {
        ...
        rentContract.property = tokenIdToProperty[_propertyNftId];
       ...
       rentContract.startDate = _startDate;
        ...
        numberOfContracts++;
        nftTokenIdToContracts[_nftTokenId].push(rentContract)
    ...
    function acceptRentContract(uint256 _propertyNftId, uint256 _rentContractId) external onlyPropertyOwner(_propertyNftId){
        if (tokenIdToProperty[_propertyNftId].rentContractsAccepted != rentContractIdToRentContract[_rentContractId].property.rentContractsAccepted || rentContractIdToRentContract[_rentContractId].status != RentContractStatus.Waiting) {
    ...
    function transferSecurityDeposit(uint256 _propertyNftId, uint256 _rentContractId) external payable {
        if (rentContractIdToRentContract[_rentContractId].status != RentContractStatus.Confirmed || rentContractIdToRentContract[_rentContractId].property != tokenIdToProperty[_propertyNftId]) {
    ...
    function terminateAgreement(uint256 _propertyNftId, uint256 _tenantTokenId, uint256 _rentContractId) external {
        ...
        if(_tenantTokenId == rentContractIdToRentContract[_rentContractId].rentContract.tenant.sbtId) {
        rentContractIdToRentContract[_rentContractId].status = RentContractStatus.Canceled;
        tokenIdToProperty[_propertyNftId].rentContract = 0; // or RentContract rentContract?
